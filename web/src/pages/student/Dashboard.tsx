...
import { LocoAssistant } from '../../components/LocoAssistant'
        ...
        <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
          ...
          <LocoAssistant
            onPartialFill={(fields) => {
              ...
              if (fields.planned_duration_minutes) setDuration(fields.planned_duration_minutes)
            }}
          />
        </div>
        <p className="text-xs text-slate-400 mb-3">
          Enable Loco, then just say "Loco" followed by what you want to study — it'll start the session for you.
        </p>
